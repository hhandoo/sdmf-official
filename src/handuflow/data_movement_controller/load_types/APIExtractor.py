...
# internal
from handuflow.data_movement_controller.BaseLoadStrategy import BaseLoadStrategy
...
from handuflow.exception.ExtractionException import ExtractionException
...
class APIExtractor(BaseLoadStrategy):
    ...
    def __extract_parquet(self) -> DataFrame:
        ...
        tmp_dir = os.path.join(
            self.config.config['DMC_CONFIG']['temp'],
